<template>
  <div class="relative">
    <div class="flex items-end gap-3 p-4 bg-gray-700/50 rounded-lg">
      <button
      ...
      <div class="flex-1">
        <textarea
          ...
          class="w-full px-4 py-2.5 bg-transparent text-gray-100 placeholder-gray-400 
                 resize-none focus:outline-hidden rounded-lg"
          rows="1"
      ...
      <div class="flex items-center gap-2 shrink-0">
        ...
        <button
          @click="sendMessage"
          :disabled="!canSend"
          class="p-2 hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed 
    ...
    <!-- Character Counter -->
    <div v-if="message.length > 1800" class="absolute -top-8 right-4 text-xs"
